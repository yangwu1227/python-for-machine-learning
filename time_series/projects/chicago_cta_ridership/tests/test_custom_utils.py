...
class TestS3Helper:
    ...
    def test_read_parquet(self, sample_data, s3_helper):
        ...
        with mock_s3():
            ...
            conn.Object('yang-ml-sagemaker', 'chicago_cta_ridership/sample.parquet').put(Body=buffer.getvalue())
    ...
    def test_to_parquet(self, sample_data, s3_helper):
        ...
        with mock_s3():
            ...
            obj = conn.Object('yang-ml-sagemaker', 'chicago_cta_ridership/test_output.parquet').get().get('Body').read()
    ...
    def test_upload_joblib(self, sample_model, s3_helper):
        ...
        with mock_s3():
            ...
            obj = conn.Object('yang-ml-sagemaker', 'chicago_cta_ridership/sample_model.joblib')
            assert obj.get()
    ...
    def test_download_joblib(self, sample_model, s3_helper):
        ...
        with mock_s3():
            ...
            conn.Object('yang-ml-sagemaker', 'chicago_cta_ridership/sample_model.joblib').put(Body=buffer.getvalue())
            ...
            for param_key in downloaded_model_params:
                assert downloaded_model_params[param_key] == sample_model_params[param_key]