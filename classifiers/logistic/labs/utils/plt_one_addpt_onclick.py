...
class plt_one_addpt_onclick:
    ...
    logistic : bool, optional
        Whether to use logistic regression (default is True).
    ...
    def calc_linear(self, event):
        """Calculate linear regression and update the plot.
    ...
    def calc_logistic(self, event):
        """Calculate logistic regression and update the plot.
    ...
    def thresh(self, event):
        """Toggle the threshold on the plot.
    ...
    def draw_thresh(self):
        """Draw the threshold on the plot."""
    ...
    def remove_thresh(self):
        """Remove the threshold from the plot."""
    ...
    def resize_sq(self, bcid):
        ...
        Parameters
        ----------
        bcid : matplotlib.widgets.CheckButtons
            The check button to resize.
