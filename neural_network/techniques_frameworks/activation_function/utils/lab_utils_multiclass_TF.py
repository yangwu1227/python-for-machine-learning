...
def plot_cat_decision_boundary_mc(ax: mpl.axes.Axes, X: np.ndarray, predict: Callable,
                                  class_labels: Optional[List[str]] = None, legend: bool = False, vector: bool = True) -> None:
    """
    ...
    vector : bool, optional
        Whether the prediction is vectorized.
...
def plt_mc_data(ax: mpl.axes.Axes, X: np.ndarray, y: np.ndarray, classes: int,  
                class_labels: Optional[List[str]] = None, 
                map: mpl.colors.Colormap = plt.cm.Paired, 
                legend: bool = False, size: int = 50, m: str = 'o', 
                equal_xy: bool = False) -> None:
    """
    ...
    class_labels : Optional[List[str]], optional
        The class labels.
    map : mpl.colors.Colormap, optional
        The colormap to use.
    legend : bool, optional
        Whether to show the legend.
    size : int, optional
    ...
    m : str, optional
        The marker style.
    equal_xy : bool, optional
        Whether to set equal scaling for x and y axes.
...
def plt_cat_mc(X_train: np.ndarray, y_train: np.ndarray, model: Any, classes: int) -> None:
    """
    Plot the decision boundary for a given model on the training data.
