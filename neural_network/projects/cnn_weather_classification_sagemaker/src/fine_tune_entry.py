...
def fine_tune_cnn(logger: logging.Logger,
                  ...
                  verbose: int = 2) -> Tuple[tf.keras.models.Sequential, tf.keras.callbacks.EarlyStopping]:
    """
    ...
    logger.info(f'Best validation accuracy after training classifier: {early_stopper_clf.best}')
