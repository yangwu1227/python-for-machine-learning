...
def ingest_images_and_masks(path_queue: Queue, image_paths: list, mask_paths: str, images: np.ndarray, masks: np.ndarray, image_size: Tuple[int, int]) -> None:
    """
...
if __name__ == '__main__':
    ...
    with futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        future_tasks = [executor.submit(ingest_images_and_masks, path_queue, image_paths, mask_paths, images, masks, image_size)
