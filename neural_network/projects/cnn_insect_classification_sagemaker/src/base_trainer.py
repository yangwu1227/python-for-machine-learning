...
class BaseTrainer(object):
    ...
    def _create_optimizer(self, learning_rate: float) -> tf.keras.optimizers.Optimizer:
        """
        This function creates an Adam optimizer based on hyperparameters.
        ...
        optimizer = tf.keras.optimizers.Adam(
            ...
            beta_1=self.hyperparameters["opt_adam_beta_1"],
            beta_2=self.hyperparameters["opt_adam_beta_2"],
            clipnorm=self.hyperparameters["opt_clipnorm"],
        )
    ...
    def _create_loss_fn(self) -> tf.keras.losses.Loss:
        """
        This function creates a loss function based on hyperparameters.
