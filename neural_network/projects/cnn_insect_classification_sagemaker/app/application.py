...
baseline_model = tf.keras.models.load_model(os.path.join(os.path.dirname(__file__), 'models/baseline'))
fine_tune_model = tf.keras.models.load_model(os.path.join(os.path.dirname(__file__), 'models/fine_tune'))
...
def upload_and_predict():
    if request.method == 'POST':
        ...
        if image_file:
            ...
            return render_template('index.html', predicted_class=class_name, image_plot=image_plot) 
